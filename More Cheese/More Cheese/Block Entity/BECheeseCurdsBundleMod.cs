...
/* using this code just to kind of figure out what I'm doing, this is from the game, I did not write it
 * 
 */
#nullable disable
...
{ 
    ...
    public class BECheeseCurdsBundleMod : BlockEntityContainer
    {
        ...
        public EnumCurdsBundleModState State
        {
            get
            {
                return state;
        ...
        public override void OnBlockPlaced(ItemStack byItemStack = null)
        {
            if (byItemStack != null)
            {
                inv[0].Itemstack = (byItemStack.Block as BlockCheeseCurdsBundleMod)?.GetContents(byItemStack);
            }
        }
        ...
        {
            if (state != EnumCurdsBundleModState.BundledStick || listenerId != 0) return;
        ...
        public override void FromTreeAttributes(ITreeAttribute tree, IWorldAccessor worldForResolving)
        {
            ...
            state = (EnumCurdsBundleModState)tree.GetInt("state");
        ...
        public override bool OnTesselation(ITerrainMeshPool mesher, ITesselatorAPI tessThreadTesselator)
        {
            ...
            {
                animUtil?.InitializeAnimator("curdbundle", (Block as BlockCheeseCurdsBundleMod).GetShape(EnumCurdsBundleModState.BundledStick), null, animRot);
            }
            ...
            if (!skipMesh)
            {
                mesher.AddMeshData((Block as BlockCheeseCurdsBundleMod).GetMesh(state, meshangle));
            }
