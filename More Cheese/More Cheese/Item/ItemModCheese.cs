...
{
    public class ItemModCheese : Item
    {
        ...
        public override void OnHeldInteractStart(ItemSlot slot, EntityAgent byEntity, BlockSelection blockSel, EntitySelection entitySel, bool firstEvent, ref EnumHandHandling handling)
        {
            if (byEntity.Controls.ShiftKey && blockSel != null)
            {
                ...
                Block placeblock = api.World.GetBlock(new AssetLocation("morecheese:cheesemod"));
                ...
                {
                    BECheeseMod bec = api.World.BlockAccessor.GetBlockEntity(targetPos) as BECheeseMod;
                    if (bec != null)
                    {
                        slot.TakeOut(1);
                        slot.MarkDirty();
